...
> 已完成 40 项 / 总计 63 项。Phase-1 纯软件全部完成。剩余 23 项分类：🟠 Python 训练侧配合 2 项（R-13, R-16-②）、🟡 硬件实测 4 项（R-16-①③, R-50, R-51）、🟠 Phase-2 6 项、🔵 Phase-3 4 项、另有 R-34/R-35（export_bin.py 建议项）和 R-18（离线工具链）在正文 H 节。R-47~R-51 + P1/P3 为 2026-07-28 实时运行日志分析发现。R-52~R-57 为 2026-07-29 对抗性审查发现并于同日修复。
...
| 40 | **R-33** cnn_m5_free 完整释放 CNN 权重+激活缓冲 — 支持 OTA/热切换 | 建议 | Phase-1 | `72164c8` |
...
```
Phase-1 收尾:         ✅ 全部完成 (R-52~R-57 + R-33, 2026-07-29)
Python 训练侧:        R-16-② (.bin格式头+export_bin.py) → R-13 (bp256tap新FIR系数)
硬件可用时:           R-16-① (Ŝ实测) → R-16-③ (Ŝ质量门禁) → R-50 (spk1重标) → R-51 (125Hz排查)
